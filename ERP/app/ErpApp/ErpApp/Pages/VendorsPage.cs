...
{
    public class VendorsPage : MvxContentPage<ViewModels.VendorsViewModel>, IMvxOverridePresentationAttribute
    {
		public VendorsPage()
		{
            Title = "Vendors";
            this.IconImageSource = new FileImageSource() { File = "Vendors" };
            Xamarin.Forms.PlatformConfiguration.iOSSpecific.Page.SetUseSafeArea(this, true);

            if (Device.Idiom == TargetIdiom.Phone)
            {
                var content = new Vendors.VendorsPhoneView();
            ...
            {
                Content = new Vendors.VendorsTabletView();
