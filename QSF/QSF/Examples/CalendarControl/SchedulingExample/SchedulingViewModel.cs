...
namespace QSF.Examples.CalendarControl.SchedulingExample
{
    public class SchedulingViewModel : ExampleViewModel
    {
        ...
        private bool isAddAppointmentButtonVisible;
        ...
        public bool IsAddAppointmentButtonVisible
        {
            get
            {
                return this.isAddAppointmentButtonVisible;
            }
            set
            {
                if (value != this.isAddAppointmentButtonVisible)
                {
                    this.isAddAppointmentButtonVisible = value;
        ...
        public ViewMode SelectedMode
        {
            ...
            set
            {
                if (this.selectedMode != value)
                {
                    ...
                    this.SetAddAppointmentButtonVisibility();
        ...
        private void SetAddAppointmentButtonVisibility()
        {
